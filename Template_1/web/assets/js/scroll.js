...
$(document).ready(function() {
    setTimeout(function() {
        ...
        if ($('#container_loding').hasClass('loaded')) {
...
var swiper = new Swiper(".slide-container_bus", {
    autoplay: {
        delay: 4000,
    },
    slidesPerView: 4,
...
var swiper = new Swiper(".slide-container_box_2", {
    autoplay: true,
    slidesPerView: 4,
    spaceBetween: 20,
    sliderPerGroup: 4,
...
var swiper = new Swiper(".slide-container_bus_box2", {
    autoplay: {
        delay: 4000,
    },
    slidesPerView: 4,
